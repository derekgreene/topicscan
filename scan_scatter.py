#!/usr/bin/env python
"""
Script providing access to the TopicScan page for viewing scatter plots for a given topic model.
...
def main():
	...
	try:
		...
		layout = ScatterLayout(webcore, topic_metadata)
